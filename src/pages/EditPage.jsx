...
const EditProduct = ({ product }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.put(`${process.env.REACT_APP_API_URL}/product/edit/${id}`,editedProduct)
            ...
            <form className="container flex"  onSubmit={handleSubmit}>
                <div className="edit-page flex">
                    ...
                    <div className="form">
                        ...
                        <input type="text"name="productName"value={editedProduct.name}onChange={handleInputChange}/>
